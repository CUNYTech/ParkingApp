...
/**
 * Created by YaxiangZou on 11/6/17.
 */
...
public abstract class PermissionUtils {
    ...
    public static void requestPermission(AppCompatActivity activity, int requestId, String permission, boolean finishActivity) {
        if (android.support.v4.app.ActivityCompat.shouldShowRequestPermissionRationale(activity, permission)) {
            ...
            android.support.v4.app.ActivityCompat.requestPermissions(activity, new String[]{permission}, requestId);
        }
    }
    ...
    public static class RationaleDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity()).setMessage(R.string.permission_rationale).setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
